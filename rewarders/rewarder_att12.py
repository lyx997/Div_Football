...
def calc_reward(rew, prev_obs, obs, skill_reward, opp_num, left_owned_ball):
    ...
    if prev_obs:
        ...
        reward = 5.0*win_reward + 5.0*rew + 0.01*yellow_r + 0.003*ball_position_r + 0.01*not_owned_ball_dis_reward + 0.01*owned_ball_dis_reward + 0.1*change_ball_owned_reward + 0.01*skill_div_reward 
    return reward #, ball_position_r, skill_div_reward, not_owned_ball_dis_reward, owned_ball_dis_reward, change_ball_owned_reward