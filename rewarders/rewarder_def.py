...
def calc_reward(rew, prev_obs, obs, opp_num):
    ...
    if prev_obs:
        ...
        if prev_owned_ball_team == 1 and owned_ball_team != 0:
    ...
    reward = 5.0*win_reward + 5.0*rew + 0.1*yellow_r + 0.001*ball_position_r + 0.01*change_ball_owned_reward + 0.1*not_owned_ball_reward
