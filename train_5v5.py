...
if __name__ == '__main__':
    ...
    arg_dict = {
        ...
        "num_processes": 9,  # should be less than the number of cpu cores in your workstation. #30
        "batch_size": 32,   
        "buffer_size": 6,
        "rollout_len": 30,
        ...
        "env_evaluation":'5_vs_5'  # for evaluation of self-play trained agent (like validation set in Supervised Learning)
    }
